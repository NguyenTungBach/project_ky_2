...
@section('breadcrumb')
    <div class="page-title">
        <div class="title_left">
            <h3>Danh sách Bài Viết Sản Phẩm Nhà Vườn</h3>
        </div>
    </div>
@endsection
        ...
        <div class="col-md-12 col-sm-12 ">
            <div class="x_panel">
                <div class="x_title">
                    ...
                    <h5>Lọc bài viết nhà vườn</h5>
                    <div class="x_title">
                        <form action="/admin/blog/farm/search" method="get" id="form-search">
                            @csrf
                            <div class="col-sm-12 col-md-12">
                                {{--              Find By Name                  --}}
                                <div class="col-md-3 col-sm-3 form-group pull-right pr-2  top_search">
                                    <input type="text" class=" form-control query"
                                           value="{{$oldName ?? ""}}" name="title"
                                ...
                                {{--              Find By Farm                 --}}
                                <div class="col-md-3 col-sm-3 form-group pull-right pr-2 top_search">
                                    <select name="farm_id" class="form-control sortOrder" id="farm">
                                        <option value="">---Nhà vườn---</option>
                                    ...
                                    @foreach($items as $item)
                                        <tr>
                                            ...
                                            @switch($item->status)
                                                ...
                                                @break
                                            @endswitch
                                            <td><a href="/admin/blog/farm/detail/{{$item->id}}" class="hover-pointer dataItem"
                                                >
