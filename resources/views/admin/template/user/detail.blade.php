                ...
                <div class="x_content">
                    @if(isset($item))
                        <section class="content invoice">
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        @foreach($item->orders as $order)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="/admin/order/detail/{{$order->id}}" class="hover-pointer dataItem">
                            ...
                            <!-- /.row -->
                            <a class="btn btn-secondary" href="/admin/users"><i class="fa fa-arrow-left"></i> Quay về danh sách khách hàng</a>
                        </section>
