...
@section('content-page')
    ...
    <div class="bg0 p-tb-100">
        <div class="container">
            <form action="/user/edit" method="post" name="register">
                @csrf
                <div class="row">
                    <div class="col-3"></div>
                                            ...
                                            <div class="row ">
                                                ...
                                                <div class="col-sm-6 p-b-23">
                                                    <div>
                                                        ...
                                                        <div class="txt-s-101 cl6 p-b-10" style="font-weight: bolder">Họ và tên</div>
                                                        <input
                                                            class="txt-s-115 cl3 size-a-21 bo-all-1 bocl15 p-rl-20 focus1"
                                                            value="{{$items->name ?? Request::old('name')}}" type="text" name="name"
                                                ...
                                                <div class="col-sm-6 p-b-23">
                                                    <div>
                                                        <div class="txt-s-101 cl6 p-b-10" style="font-weight: bolder">Địa chỉ</div>
                                                        <input
                                                            class="txt-s-115 cl3 size-a-21 bo-all-1 bocl15 p-rl-20 focus1"
                                                            value="{{$items->address ?? Request::old('address')}}" type="text"
                                                ...
                                                <div class="col-sm-12 p-b-23">
                                                    <div>
                                                        ...
                                                        <input
                                                            class="txt-s-115 cl3 size-a-21 bo-all-1 bocl15 p-rl-20 focus1"
                                                            value="{{$items->phone ??Request::old('phone')}}" type="text" name="phone"
                                                ...
                                                <div class="col-md-12 col-sm-12 text-center">
                                                    ...
                                                    <a href="/user/information" class="btn btn-primary">
                                                        Quay lại
                                                    </a>
                                                </div>
                                            </div>
