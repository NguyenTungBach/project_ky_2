$(function () {
  ...
  QUnit.test('should sanitize page by removing disallowed tags', function (assert) {
    assert.expect(1)
  ...
  QUnit.test('should sanitize page by removing disallowed attributes', function (assert) {
    assert.expect(1)
  ...
  QUnit.test('should sanitize page by removing tags with XSS', function (assert) {
    assert.expect(1)
